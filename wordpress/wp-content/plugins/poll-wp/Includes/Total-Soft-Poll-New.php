<?php
	...
	if($_SERVER["REQUEST_METHOD"]=="POST")
	{
		...
		{
			$TotalSoftPoll_Question = str_replace("\&","&", sanitize_text_field(sanitize_text_field($_POST['TotalSoftPoll_Question'])));
			...
			{
				$TotalSoftPoll_Ans[$i] = str_replace("\&","&", sanitize_text_field(sanitize_text_field($_POST['TotalSoftPoll_Ans_' . $i])));
