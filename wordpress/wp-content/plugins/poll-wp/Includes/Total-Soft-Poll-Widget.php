...
class Total_Soft_Poll extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		// $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10 = false;
		...
		<?php if ( $Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Standart Poll' || $Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Standard Poll' ) { ?>
          <style type="text/css">
              ...
              <?php echo $Total_Soft_Poll;?> { width: 74% !important; left: 13% !important; }*/
              }
              ...
              <?php echo $Total_Soft_Poll;?> { width: 100% !important; left: 0% !important; }*/
          ...
          <form method="POST" onsubmit="">
              <div class="Total_Soft_Poll_Main_Div">
                  <div class="Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll; ?>">
                      ...
                      <div class="Total_Soft_Poll_1_Quest_Div_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_1_Quest_Fin_Div_<?php echo $Total_Soft_Poll; ?>">
                      ...
                      <div class="Total_Soft_Poll_1_But_MDiv_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_1_But_Fin_MDiv_<?php echo $Total_Soft_Poll; ?>">
                      ...
                      <div class="Total_Soft_Poll_1_Main_Ans_Div_<?php echo $Total_Soft_Poll; ?>">
                          ...
                          <div class="Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_1_Ans_Fin_Div_<?php echo $Total_Soft_Poll; ?>">
														<?php for ( $i = 0; $i < $Total_Soft_Poll_Man[0]->TotalSoftPoll_Ans_C; $i ++ ) { ?>
                                <div class="Total_Soft_Poll_1_Ans_Check_Div">
                                    <label class="Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll; ?>">
                                        ...
                                        <span class="Total_Soft_Poll_1_Ans_Lab_Sp2_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_1_Ans_Lab_Sp2_<?php echo $Total_Soft_Poll; ?>_<?php echo $i; ?>"
                  ...
                  <input type="text" style="display: none;"
                         ...
                         value="<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_ShPop; ?>">
                  <input type="text" style="display: none;"
                         id="TotalSoft_Poll_1_P_ShEff_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_ShEff; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_1_MW_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_MW; ?>">

                  <input type="text" style="display: none;" id="TotalSoft_Poll_1_ID"
                         value="<?php echo $Total_Soft_Poll; ?>">
                  ...
                  <input type="text" style="display: none;" id="TotalSoft_Poll_1_BR_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_BR; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_1_P_BW_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_1_P_BW; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_1_Pos_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_1_Pos; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Set_01_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_01; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Set_02_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_02; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Set_03_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_03; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Set_04_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo html_entity_decode( $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_04 ); ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Set_05_<?php echo $Total_Soft_Poll; ?>"
		...
		<?php } else if ( $Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Image Poll' || $Total_Soft_Poll_Themes[0]->TotalSoft_Poll_TType == 'Video Poll' ) { ?>
          ...
          <style type="text/css">
              ...
              <?php echo $Total_Soft_Poll;?> { width: 80% !important; left: 10% !important; }*/
              }
          ...
          <form method="POST" onsubmit="">
              <div class="Total_Soft_Poll_Main_Div">
                            ...
                            <script type="text/javascript">
                              ...
                              function f() {
                                ...
                                jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom', '<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_A_IH;?>px;')
																<?php }?>
                                // jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom',parseInt(jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom'), 10)*(1-y)+'px');
                                ...
                                // body...
                                // console.log(jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div_BO_<?php echo $Total_Soft_Poll;?>').width())

                                // jQuery('..Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div input + label').css('width',)
                                ...
                                jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div input + label').css('top', parseInt(jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?>').css('padding-bottom'), 10) / 2 - (x / 2) + 'px')
																<?php }?>
                                // jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?>').css('display','none')
                                // setTimeout(jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div_BO_<?php echo $Total_Soft_Poll;?>').css('height',jQuery('.Total_Soft_Poll_1_Main_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Div_<?php echo $Total_Soft_Poll;?> .Total_Soft_Poll_1_Ans_Check_Div .Total_Soft_Poll_1_Ans_Ratio_<?php echo $Total_Soft_Poll;?> img').css('height')),1000)
                  ...
                  <input type="text" style="display: none;"
                         ...
                         value="<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_2_P_A_VEff; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Set_01_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_01; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_ID"
                         value="<?php echo $Total_Soft_Poll; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Vote"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Set_02_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_02; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Set_03_<?php echo $Total_Soft_Poll; ?>"
          ...
          <form method="POST" onsubmit="">
              <div class="Total_Soft_Poll_Main_Div">
                  ...
                  <input type="text" style="display: none;" id="TotalSoft_Poll_3_ID"
                         value="<?php echo $Total_Soft_Poll; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_3_Vote"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_3_V_Eff_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_3_V_Eff; ?>">
                  <input type="text" style="display: none;" id="TotalSoftPoll_Ans_C_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Man[0]->TotalSoftPoll_Ans_C; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Set_01_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_01; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Set_02_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_02; ?>">
          ...
          <form method="POST" onsubmit="">
              <div class="Total_Soft_Poll_Main_Div">
                  ...
                  <input type="text" style="display: none;" id="TotalSoft_Poll_3_IV_ID"
                         value="<?php echo $Total_Soft_Poll; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_3_IV_Vote"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10; ?>">


                  <input type="text" style="display: none;" id="TotalSoft_Poll_3_V_Eff_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_4_V_Eff; ?>">
                  <input type="text" style="display: none;" id="TotalSoftPoll_Ans_C_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Man[0]->TotalSoftPoll_Ans_C; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Set_01_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_01; ?>">
			...
			<?php if ( $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_4_Pop_Show == 'true' ) { ?>
				...
				<?php } else { ?>
                  ...
                  <div class="Total_Soft_Poll_1_Ans_Fix_3_<?php echo $Total_Soft_Poll; ?>"
                      ...
                      <img src=""/>
                      <i class="totalsoft Total_Soft_Poll_1_Popup_Close_Icon_<?php echo $Total_Soft_Poll; ?>"
          ...
          <form method="POST" onsubmit="">
              <div class="Total_Soft_Poll_Main_Div">
                            ...
                            <div class="Total_Soft_Poll_1_Ans_Check_Div"
                                ...
                                <label class="Total_Soft_Poll_1_Ans_Lab_<?php echo $Total_Soft_Poll; ?> totalsoft totalsoft-question-circle-o"
                                       ...
                                       style="<?php if ( $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_A_CA == 'Color' ) { ?> color: <?php echo $Total_Soft_Poll_Ans[$i]->TotalSoftPoll_Ans_Cl;?> !important <?php } ?>"
																       <?php if ( $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_VB_Show != 'true' ){ ?>onclick="Total_Soft_Poll_3_Vote(<?php echo $Total_Soft_Poll; ?>, <?php echo $Total_Soft_Poll_Ans[ $i ]->id; ?>,'<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10; ?>')" <?php } ?>><?php echo html_entity_decode( $Total_Soft_Poll_Ans[ $i ]->TotalSoftPoll_Ans ); ?></label>
                                <span class="Total_Soft_Poll_3_Span_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_3_Span_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>">
												<span class="Total_Soft_Poll_3_Span3_<?php echo $Total_Soft_Poll; ?>">
													<span class="Total_Soft_Poll_3_Span1_<?php echo $Total_Soft_Poll; ?> Total_Soft_Poll_3_Span1_<?php echo $Total_Soft_Poll; ?>_<?php echo $i + 1; ?>"
                  ...
                  <input type="text" style="display: none;" id="TotalSoft_Poll_5_IV_ID"
                         value="<?php echo $Total_Soft_Poll; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_5_IV_Vote"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_10; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_3_V_Eff_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Theme_1[0]->TotalSoft_Poll_5_V_Eff; ?>">
                  <input type="text" style="display: none;" id="TotalSoftPoll_Ans_C_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Man[0]->TotalSoftPoll_Ans_C; ?>">
                  <input type="text" style="display: none;"
                         id="TotalSoft_Poll_5_TV_Show_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Theme[0]->TotalSoft_Poll_5_TV_Show; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Set_01_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_01; ?>">
                  <input type="text" style="display: none;" id="TotalSoft_Poll_Set_02_<?php echo $Total_Soft_Poll; ?>"
                         value="<?php echo $Total_Soft_Poll_Set[0]->TotalSoft_Poll_Set_02; ?>">
