...
Source:
    - https://pxhere.com/en/photo/757895
    - https://pxhere.com/en/photo/813951
    - https://pxhere.com/en/photo/746597
    - https://pxhere.com/en/photo/1233158
...
# Elegant Pink bundles the following third-party resources:
...
== Changelog ==
    ...
    * Fixed permalink issue in recent posts and popular posts widget
    * Added tested up to and require php in style header
    * Changed demo link
    * Replaced custom excerpt function with wp_trim_words
    ...
    * Added useful plugin option in getting started page
    ...
    1.2.4
    * Accessibility issue fixed on Microsoft Edge.
