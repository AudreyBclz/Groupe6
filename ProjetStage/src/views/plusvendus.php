            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-3">
                    <div class="card h-100 panneau m-1">
                        <?php if($cafe->stockCafe==0){echo'<img class="card-img-top h-50" src="public/img/epuise.png">' ;}else{ ?><img src="public/img/<?= $cafe->photoCafe ?>" class="card-img-top h-50" alt="..."><?php ;} ?>
