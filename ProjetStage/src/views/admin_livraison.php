...
//déclaration globale des variables pour adresse de livraison et total
 $total=0;
                        ...
                        <table class="table">
                            ...
                            foreach ($tab_commande as $achat)
                            {
                                ...
                                if ($achat->date_c === $date && $achat->users_idUsers === $idUser)
                                {
                                    ...
                                    /* si date != on ferme le tableau et ajoute la colonne pour les adresses*/?>
                                            <tr>
                                   ...
                                   <form class="putDelivery btn bg-wheat" method="post" action="dateLivraison">
                                        <input type="number" name="id_user" value="<?= $achat->users_idUsers ?>" class="d-none">
                                        <input type="text" name="date" value="<?= $date_non_form ?>" class="d-none">
                                        <button  type="submit" class="btn bg-wheat">Envoyer en livraison</button>
                                   </form>
    ...
    array_push($tab_liv,$data);
                                ...
                                <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                                    <div class="d-flex justify-content-between mb-5 mt-5">
                                     ...
                                     <form class="putDelivery btn bg-wheat" method="post" action="dateLivraison">
                                        <input type="number" name="id_user" value="<?= $tab_liv[0]->users_idUsers ?>" class="d-none">
                                        <input type="text" name="date" value="<?= $date_non_form ?>" class="d-none">
                                        <button  type="submit" class="btn bg-wheat">Envoyer en livraison</button>
                                    </form>
