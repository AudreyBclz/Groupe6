    ...
    <div class="container mx-auto">
        <div class="arr_plan row justify-content-center">
            <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 d-flex flex-column">
                ...
                <form method="post" action="inscription" class="m-1" id="form_ins">
                    ...
                    <div class="row justify-content-between">
                        ...
                        // on remplace la clé "place name" par "placeName"
                                ...
                                ?>
                                <select class="form-control w-45" name="ville">
                            ...
                            { ?>
                                <input type="text" id="ville" class="form-control w-45" name="ville" required/>
                                </div>
                                <div class="row">
                                    <label for="pays">Pays :</label>
                                </div>
                                <div class="row">
                                    <input type="text" class="form-control w-45" name="pays" id="pays" required/>
                                </div>
                            <?php  } } else {?>
                            <input type="text" id="ville" class="form-control w-45" name="ville" required/>
                            </div>
