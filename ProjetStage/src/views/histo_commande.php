                    ...
                    <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 d-flex flex-column">
                        ...
                        <table class="table">
                            ...
                            foreach ($tab_commande as $achat)
                            {
                                ...
                                {
                                    //si date identique on continue de remplir le tableau
                                   ...
                                   /* si date != on ferme le tableau et ajoute la colonne pour les adresses puis on ouvre un nouveau tableau  */ ?>
                                            <tr>
